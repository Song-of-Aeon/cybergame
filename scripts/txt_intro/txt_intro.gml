function txt_intro() {
	...
	endevent = function() {/*c_generatestage(c_getstage().generation)*/ o_miscdraw.drawdec = true ISAAC.state = st_standard audio_stop_all() audio_play_sound(m_stage1,0,true)};
}
